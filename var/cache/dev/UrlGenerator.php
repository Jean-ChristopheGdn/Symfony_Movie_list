...
return [
    ...
    'admin_edit_user' => [['id'], ['_controller' => 'App\\Controller\\AdminController::editUser'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/admin/user/edit']], [], []],
    ...
    'search_show' => [['id'], ['_controller' => 'App\\Controller\\SearchController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/search']], [], []],
    ...
    'users_show' => [['id'], ['_controller' => 'App\\Controller\\UsersController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/users']], [], []],
    'users_edit' => [['id'], ['_controller' => 'App\\Controller\\UsersController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/users']], [], []],
    'users_delete' => [['id'], ['_controller' => 'App\\Controller\\UsersController::delete'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/users']], [], []],
